...
Este bloque crea la figura `figures/eda_principal.png`, que se puede usar directamente en el informe.
...
![Figura exploratoria principal](figures/eda_principal.png)
...
Este bloque crea la figura `figures/diagnosticos_m3.png`.
...
![Diagnósticos del Modelo 3](figures/diagnosticos_m3.png)
